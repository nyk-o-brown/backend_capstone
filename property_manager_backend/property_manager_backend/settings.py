"""
Django settings for property_manager_backend project.
...
# load .env earlier in dev settings (python-dotenv)
...
SECRET_KEY = 'django-insecure-7(vdk+kk4v00boow*$w!j%xf@vqo9_ly07v9weh5vy0^m(s1!b'
